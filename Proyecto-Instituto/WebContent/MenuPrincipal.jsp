...
<div class="contenedor">
		<div class="botones">
			...
			<ul class="list-group">
			  ...
			  <a href="MenuPrincipal.jsp" ><li class="list-group-item list-group-item-action list-group-item-secondary">Menú Principal</li></a>
			  <br>
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      ...
				      <div class="modal-footer">
				        ...
				        <a href="index.jsp"><button type="button" class="btn btn-primary"> Cerrar Sesión</button></a>
				      </div>
				    </div>
				  </div>
				</div>
