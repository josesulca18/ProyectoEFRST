...
<div class="contenedor">
		...
		<div class="cuerpo">
			<form action="ControladorRegistrarAlumno" method="post">
				<table align="center">
				<br><br>
				<h2 style="color: white;" align="center">Registrar Alumno</h2>
				 ...
				 <br><br>
					...
					<tr>
						...
						<td>				
							      <input type="text" name="password"  value="<%= contraseñaGenerada %>" class="form-control mb-2" readonly> 
						</td>
					</tr>
